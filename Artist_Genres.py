...
# Dictionary mapping artist IDs to their custom genres
ARTIST_GENRE_MAPPINGS: Dict[str, List[str]] = {
    '3rIZMv9rysU7JkLzEaC5Jp': [  # Snow Patrol
        'alternative rock',
        'rock',
        'power pop',
        'post-britpop',
    ...
    '6ogn9necmbUdCppmNnGOdi': [  # Alanis Morrisette
        'alternative rock',
        'post-grunge',
        'electronic',
        'trip hop',
    ...
    '5oRnbmgqvvq7fVlgk4vcEa': [  # Gary Jules
        'rock',
        'pop',
        'folk',
        'soft rock'
    ...
    '2iEvnFsWxR0Syqu2JNopAd': [  # Smash Mouth
        'alternative rock',
        'power pop',
        'pop rock',
        'ska punk'
    ],
    '4BntNFyiN3VGG4hhRRZt9d': [  # The Subways
        'punk rock',
        'alternative rock',
        'indie rock',
        'garage rock',
    ...
    '4apX9tIeHb85yPyy4F6FJG': [  # Wild Cherry
        'funk rock',
        'blue-eyed soul',
        'disco',
        'r&b'
    ],
    '4g6EnIPhmYBTZ7vsmxDkxH': [  # Downstait
        'alternative metal',
        'alternative rock',
        'hard rock'
    ],
    '10n5DVRlZbjbZ5ffpwpn6l': [  # Rev Theory
        'hard rock',
        'post-grunge',
        'nu metal',
        'alternative metal'
    ],
    '1TqQi97nqeiuOJrIFv5Sw0': [  # Semisonic
        'alternative rock',
        'pop rock',
        'post-grunge',
        'power pop'
    ...
    '4tvKz56Tr39bkhcQUTO0Xr': [  # Angus & Julia Stone
        'folk rock',
        'indie pop',
        'americana'
    ],
    ...
    '19xz1vcuKNjniGEftTOSSH': [  # The Weather Girls
        'hi-nrg',
        'disco',
        'pop',
        'soul'
...
def get_custom_artist_genres(artist_id: str) -> List[str]:
    """
    Get custom genre mappings for artists that don't have genres listed in Spotify.
    Returns an empty list if no custom mapping exists for the artist.
    """
    return ARTIST_GENRE_MAPPINGS.get(artist_id, []) 